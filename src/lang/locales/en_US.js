module.exports = {
   ...
   // New Title for Solar Topps
   "sidebar.manageuser": "Manage Users",
   "sidebar.manageBulkImport": "Manage Bulk Import",
   "sidebar.bulkImport": "Bulk Import",
   "sidebar.inventory": "Manage Inventory",
   "sidebar.manageProducts": "Manage Products",
   "sidebar.manageWarehouse": "Manage Warehouse",
   "sidebar.manageSupplier": "Manage Suppliers",
   "sidebar.manageConfiguration": "Manage Configuration",
   "sidebar.Products": "Products",
   "sidebar.warehouse": "Warehouse",
   "sidebar.supplier": "Supplier",
   "sidebar.configuration": "Configuration",
   "sidebar.purchase": "Purchase",
   "sidebar.purchasePlan": "Purchase Plan",
   "sidebar.proposal": "Proposal",
   "sidebar.managePurchasePlan": "Manage Purchase Plan",
   "sidebar.customerProposal": "Customer Proposal",
   "sidebar.manageProposal": "Manage Proposal",
   "sidebar.changePassword": "Change Password",
   "sidebar.Welcome": "Welcome",
   "sidebar.home": "Home",
   "sidebar.landingPage": "Welcome",	
   "sidebar.manageCustomers": "Manage Customers",
   "sidebar.customer": "Customers",
   "sidebar.bulk": "Bulk",
   "sidebar.Inventory": "Manage Inventory",
   "sidebar.PurchasePlan": "Purchase Plan",
   "sidebar.ManagePurchase": "Manage Purchase",
   "sidebar.CustomerProposal": "Customer Proposal",
   "sidebar.UserManagement": "User Management",
   "sidebar.ManageUsers":"Manage Users",
   "sidebar.ManageCustomer": "Manage Customer",
   "sidebar.BulkImport": "Bulk Import",
   "sidebar.ManageProposal": "Manage Proposal",
   "sidebar.ManageProduct": "Manage Products",
   "sidebar.Warehouse": "Warehouse",
   "sidebar.ManageWarehouse":  "Manage Warehouse",
   "sidebar.Supplier": "Supplier",
   "sidebar.ManageSupplier": "Manage Suppliers",
   "sidebar.Configuration": "Configuration",
   "sidebar.ManageConfiguration": "Manage Configuration",
   "sidebar.userprofiledetails": "User Profile Details",
