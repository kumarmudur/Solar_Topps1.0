...
class FinanceComponent extends Component {
   constructor(props) {
      super(props);
      this.state = {
         fields: this._getInitialState(props.purchasePlanData && props.purchasePlanData.proposalType === PROPOSALTYPE.FINANCE ? props.purchasePlanData : props),
      };
...
_onFieldChangeNumeric = e => {
 ...
 _onFieldChangeNumericInt = e => {
   ...
   name === 'minimumCost' || name === 'escalationRate' || name === 'planDownPayment' 
   || name === 'discountAsPerPlan' || name === 'interestRate') {
            ...
            <div className="collapse show">
               <div className="rct-block-content">
                  ...
                  <div className="radio-group-align" onChange={this._onFieldChange}>
                     ...
                     <RadioGroup aria-label="Depreciation" name="depreciation" >
                        <FormControlLabel 
                           label="Yes" 
                           labelPlacement="end"
                           control={<Radio  
                  ...
                  <FormLabel component="legend">Ballon Payment 1</FormLabel>
                     <RadioGroup aria-label="Ballon Payment 1" name="balloonPayment1" >
                        <FormControlLabel 
                           label="Yes" 
                           labelPlacement="end"
                           control={<Radio 
                  ...
                  <div className="radio-group-align" onChange={this._onFieldChange}>
                    <FormLabel component="legend">Ballon Payment 2</FormLabel>
                     <RadioGroup aria-label="Ballon Payment 2" name="balloonPayment2" >
                        <FormControlLabel 
                           label="Yes" 
                           labelPlacement="end"
                           control={<Radio 
...
export default compose(withStyles(styles, { name: "FinanceComponent" }),)(FinanceComponent);