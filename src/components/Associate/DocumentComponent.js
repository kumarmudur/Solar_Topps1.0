...
class DocumentComponent extends Component {
    ...
    _submitForm = (files, file) => {
        ...
        if (!file || file.size<=0 ) {
            ...
            if(file.size > ASSOCIATE.ASSOCIATE_FILE_UPLOAD_SIZE) {
                fileError = ASSOCIATE.FILE_UPLOAD_SIZE_MSG;
            }
        }
        this.setState({
            error: fileError,
                    ...
                    <div className="rct-block ">
                        <div className="rct-block-title ">
                            <div className="page-heading">
                                <div className="inline-block-element">Documents</div>
                            </div>
                        </div>
                    </div>
                    }
                        ...
                        <div className="row docs-row">
                            { (type === 'ADD' || docType === 'insurance') &&
                                <div className="cols fileupload-col-width">
                                    ...
                                    <span className="upload-icon"><PublishIcon/></span>
                                        <div className={ `upload-btn-wrapper ${  insurance.name ? 'disable-upload' : '' }` }>
                                            <span className="btn-wrapper"><button className="btn">
                                            { insurancePlaceHolderText } </button></span>
                                            <input 
                                              type='file'
                                              name='file'
                                              title='insurance'
                                        ...
                                        <div className="delete">
                                            <NavLink to="#" id="removeInsurance" title="insurance" onClick={ this._addRemovefiles }><DeleteIcon className="imgIconCurosr" alt="delete" /></NavLink>
                                        </div>
                                         )}
                                    </div>
                                </div>
                                ...
                                <div className="cols fileupload-col-width">
                                    ...
                                    <span className="upload-icon"><PublishIcon/></span>
                                        <div className={ `upload-btn-wrapper ${  drivingLicense.name ? 'disable-upload' : '' }` }>
                                            <span className="btn-wrapper"><button className="btn">
                                            { drivingLicensePlaceHolderText }</button></span>
                                            <input 
                                              type='file'
                                              name='file'
                                        ...
                                        { drivingLicense.name && (
                                        <div className="delete">
                                            <NavLink to="#" id="removeDl" title="drivingLicense" onClick={ this._addRemovefiles }><DeleteIcon className="imgIconCurosr" alt="delete" /></NavLink>
                                        </div> )}
                                    </div>
                                </div>
                            }
                                ...
                                <div className="cols fileupload-col-width">
                                    ...
                                    <span className="upload-icon"><PublishIcon/></span>
                                        <div className={ `upload-btn-wrapper ${  SH4.name ? 'disable-upload' : '' }` }>
                                            ...
                                            { sh4FormPlaceHolderText } </button></span>
                                            <input 
                                              type='file'
                                              name='file'
                                              title='SH4'
                                        ...
                                        { SH4.name && (
                                        <div className="delete">
                                            <NavLink to="#" id="removeSh4" title="SH4" onClick={ this._addRemovefiles }><DeleteIcon className="imgIconCurosr" alt="delete" /></NavLink>
                                        </div> )}
                                    </div>
                                </div> 
                            }
                                ...
                                <div className="cols fileupload-col-width">
                                    ...
                                    <span className="upload-icon"><PublishIcon/></span>
                                        <div className={ `upload-btn-wrapper ${  SSN.name ? 'disable-upload' : '' }` }>
                                            ...
                                            { ssnPlaceHolderText }</button></span>
                                            <input 
                                              type='file'
                                              name='file'
                                              title='SSN'
                                        ...
                                        { SSN.name && (
                                        <div className="delete">
                                            <NavLink to="#" id="removeSsn" title="SSN" onClick={ this._addRemovefiles }><DeleteIcon className="imgIconCurosr" alt="delete" /></NavLink>
                                        </div> )}
                                    </div>
                                </div> 
                            }   
