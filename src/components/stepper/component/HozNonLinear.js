...
function getSteps() {
	return ['General Info', 'Documents', 'Agreement'];
}

// function getStepContent(step) {
// 	switch (step) {
// 		case 0:
// 			return 'Step 1: General Info';
// 		case 1:
// 			return 'Step 2: Documents';
// 		case 2:
// 			return 'Step 3: Agreement';
// 		default:
// 			return 'Unknown step';
// 	}
// }
					...
					{this.allStepsCompleted() ? (
						<div className="pl-40">
							...
							<div className="pl-40">
								...
								<Button variant="contained" className="btn-danger text-white mr-10 mb-10" disabled={activeStep === 0} onClick={this.handleBack}> Back </Button>
								<Button variant="contained" color="primary" className="text-white mr-10 mb-10" onClick={this.handleNext}> Next </Button>
